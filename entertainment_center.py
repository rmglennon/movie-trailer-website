...
# Import media.py file that defines the classes
# Import fresh_tomatoes.py that creates the movies webpage
...
all_the_presidents_men = media.Movie(
    ...
    "Two reporters investigate the Watergate scandal.",
    "https://upload.wikimedia.org/wikipedia/en/9/92/All_the_president%27s_men.jpg",  # noqa
    "https://www.youtube.com/watch?v=vLt6djxhNe8")

gone_with_the_wind = media.Movie(
    "Gone With the Wind",
    "Romance and reconstruction in Civil War-era Georgia.",
...
muppet_movie = media.Movie(
    "The Muppet Movie",
    "The Muppets travel across the country to make a movie",
    "https://upload.wikimedia.org/wikipedia/en/a/a8/The_Muppet_Movie.jpg",
    "https://www.youtube.com/watch?v=N31JLdKmHIE")

national_lampoons_vacation = media.Movie(
    "National Lampoon's Vacation",
    "Everything goes wrong on a family's roadtrip.",
    "https://upload.wikimedia.org/wikipedia/en/a/a8/Vacation1983.jpg",
    "https://www.youtube.com/watch?v=rYcz5MsDgE4")

skyfall = media.Movie(
    "Skyfall",
    "James Bond tracks a former agent-turned cyberterrorist.",
...
star_wars = media.Movie(
    "Star Wars",
    "An epic battle a long time ago in another galaxy.",
...
movies = [all_the_presidents_men, gone_with_the_wind, muppet_movie,
          national_lampoons_vacation, skyfall, star_wars]
